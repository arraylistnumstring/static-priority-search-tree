...
struct InterParaSearchTester
{
	...
	InterParaSearchTester(T min_val, T max_val, T search_val)
		: rand_num_eng(0),
		distr(min_val, max_val),
		search_val(search_val)
	{};

	InterParaSearchTester(size_t rand_seed, T min_val, T max_val, T search_val)
	...
	struct NumIDsWrapper
	{
		...
		struct IDTypeWrapper
		{
			...
			void operator()(size_t num_elems)
			{
